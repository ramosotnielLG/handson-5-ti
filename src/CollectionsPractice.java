...
public class CollectionsPractice {
    public static void main(String[] args) {
        ...
        Collections.addAll(dynamiclist, 10, 20, 30, 40, 50);

        System.out.println("Ukuran array (fixed): " +fixedArray.length);
        System.out.println("Ukuran ArrayList (dinamis): " +dynamiclist.size());
        //ArrayList dapat menambah elemen secara dinamis sementara array bersifat tetap
        ...
        daftarMahasiswa.add("Dedi");
        daftarMahasiswa.add("Eka");

        daftarMahasiswa.add(2, "Fajar");

        System.out.println("Setelah tambah: " +daftarMahasiswa);
        ...
        System.out.println("Ada 'Citra'? " +daftarMahasiswa.contains("Citra"));
        System.out.println("Index 'Dedi': " +daftarMahasiswa.indexOf("Dedi"));
        System.out.println("Ukuran daftar: " +daftarMahasiswa.size());

        daftarMahasiswa.set(1, "Budi updated");
        ...
        for(int v : angka) System.out.print(v + " ");
        System.out.println();
